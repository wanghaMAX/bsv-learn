...
module validbitsTb(CLK,
  ...
  wire pipe$EN__write, pipe$RDY__read;
  ...
  begin
    #0;
    if (RST_N != `BSV_RESET_VALUE)
      if (pipe$RDY__read) $display("y = %0h", $signed(pipe$_read));
    if (RST_N != `BSV_RESET_VALUE)
      if (pipe$RDY__read && (pipe$_read ^ 32'h80000000) > 32'h80000080)
	$finish(32'd1);
  end
  // synopsys translate_on
